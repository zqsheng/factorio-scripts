...
badd +12 ~/.zshrc
badd +1 ~/c.go
badd +11 fcpu/factorio.a.asm
badd +1 fcpu/factorio.c.asm
badd +1 ~/factorio-scripts
badd +16 fire-armor/algo.c
badd +4 ~/.vimrc
badd +9 fire-armor/algo.cc
argglobal
%argdel
...
argglobal
enew
balt ~/factorio-scripts/fire-armor/algo.c
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
