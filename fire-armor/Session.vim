...
silent only
silent tabonly
cd ~/factorio-scripts/fire-armor
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess+=aoO
badd +1 ~/factorio-scripts/app/main.js
badd +12 ~/.zshrc
badd +1 ~/c.go
badd +11 ~/factorio-scripts/fcpu/factorio.a.asm
badd +1 ~/factorio-scripts/fcpu/factorio.c.asm
badd +1 ~/factorio-scripts
badd +36 algo.c
badd +26 ~/.vimrc
badd +9 algo.cc
badd +1 ~/factorio-scripts/NERD_tree_win_2
argglobal
%argdel
